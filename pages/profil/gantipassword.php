                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-xs-12">
                                                    ...
                                                    <ul class="sidebar-menu" data-widget="tree">
                                                        ...
                                                        <li>
                                                            <a href="../profil/gantipassword.php">
                                                ...
                                                ?>
                                                  ...
                                                  <div class="box box-primary">
                                                    <div class="box-body box-profile">
                                                      ...
                                                      <form action="edit-pass.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="konfirm_password"  class="form-control"/>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="reset" class="btn btn-danger"  data-dismiss="modal" aria-hidden="true"><a href="../dashboard/index.php">
                                                                Kembali
                                                                </a>
                                                            </button>
                                                        </div>
