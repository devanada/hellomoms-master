                      ...
                      <small><strong>Berita</strong></small>
                                        ...
                                        <section class="content">
                                            <div class="row">
                                                ...
                                                <?php
                                                    $id=$_GET['id'];
                                                    $modal=mysql_query("SELECT * FROM app_berita WHERE id='".$id."'");
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <div class="box-body">
                                                            <div class="form-group">
                                                              ...
                                                              <input type="hidden" name="id_berita" value="<?php echo $id ?>" class="form-control">
                                                            ...
                                                            <div class="form-group">
                                                             <div class="box-body pad">
                                                              <form>
                                                                    <textarea id="editor1" name="input" rows="10" cols="80" required="required"><?php echo $r['isi']; ?></textarea>
                                                              </form>
                                                            </div>
                                                        </div>
